...
聚合 413 个活跃数据源（覆盖 30 个国家/地区）、8,949 条目录记录、237,593 条辞典词条、28 语种。可通过典津联检扩展至 72.8 万条跨平台古籍资源。
...
- **数据源导航**：413 个全球佛教数字资源（覆盖 30 个国家/地区），按国家/地区、语种、类型筛选，涵盖 CBETA、SuttaCentral、84000、GRETIL、BDRC 等主流佛学数据库
