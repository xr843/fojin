...
export const STATIC_SEO_PAGES: Record<string, SeoPage> = {
  search: {
    title: "搜索 | 佛津 FoJin",
  ...
  collections: {
    title: "经典专题 | 佛津 FoJin",
    desc: "按经论系列分类浏览佛教经典，包含主要经典、注疏论释及相关资源。",
    noscript:
      '<h1>佛津 — 经典专题</h1><p>按经论系列分类浏览佛教经典，每个系列收录主要经典、注疏论释与相关外部资源。</p><h2>经论系列</h2><ul><li>华严经系列</li><li>般若经系列</li><li>法华经系列</li><li>楞严经系列</li><li>净土经系列</li><li>唯识系列</li><li>禅宗经典系列</li><li>律典系列</li><li>阿含经/尼柯耶系列</li><li>密教系列</li><li>涅槃经系列</li><li>阿毗达磨系列</li><li>南传巴利三藏</li></ul><a href="/">返回首页</a>',
  },
  topics: {
    title: "经典专题 — 佛津 FoJin",
