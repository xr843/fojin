...
- `base_url` corrected for 9 relocated sources and `suttaworld` deactivated (migration 0137) — its domain lapsed and now redirects to an unrelated gambling site.
