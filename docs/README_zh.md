...
| **跨藏经对读经文** | **三语跨藏对读** —— 3,400+ 条 LLM 验证段对，覆盖《妙法蓮華經》↔ Toh 113（**259 对，2026-06-08 上线**）、维摩诘、心经、四阿含 ↔ 尼柯耶全集、法句等 10 个 pair 定义 |
...
置信度分布：全部 ≥ 0.80，88% ≥ 0.95。原 MVP 抽样精度 **100%**。法华批次 2026-06-08 上线，DeepSeek API 成本 **$1.70 / 259 对**（3,029 条 LLM 验证候选中接受率 8.6%）。
...
- [x] **三语跨藏经对读** —— 10 个 pair 定义，3,400+ 条 LLM 验证对齐（CBETA / SuttaCentral / 84000；含法华 ↔ Toh 113 第一部大乘汉藏批次、四阿含 ↔ 尼柯耶全集、原 MVP 5 经）
