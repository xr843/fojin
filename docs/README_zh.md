...
用自然语言提问，FoJin 的「小津」直接从藏经里答你 —— 检索增强生成（RAG）覆盖 68 万+ 段经文向量，关键词重排 + 本经召回，**可点击的 `【《经名》第N卷】` 引文**一点即开对应原文，反幻觉校验，引文抽屉还能 **汉 / 巴利 / 藏文 并列对照跨藏经**。也可切换 **14 位历史法师人格** 提问，每位限定其宗派核心经典。
...
| 用某位法师的口吻问 | **法师人格模式** —— 14 位历史法师，各自限定其宗派核心经典 RAG |
